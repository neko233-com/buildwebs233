...
- 内置 40+ 行业模板，覆盖企业、游戏、电商、博客、科技、科研、外包、音乐、文化、新闻、医疗、教育、金融
...
- `docs/guide.html`：快速开始
- `docs/templates.html`：模板库手册
- `docs/compliance.html`：备案中心与审核流
- 推送到 `main` 后，GitHub Actions 会自动把 `docs/` 发布到 GitHub Pages
